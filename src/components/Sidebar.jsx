...
<div class={`flex dark:bg-gray-200 text-gray-900`}>
  ...
  <aside class="flex h-screen w-20 flex-col items-center border-r border-gray-200 bg-white">
    ...
    <a href="/allnote" class={`${pathname === '/allnote' ? 'text-blue-600' : 'text-black' } group relative rounded-xl bg-gray-100 p-2 hover:bg-gray-50`}>
      ...
      <a href="/addnote" class={`${pathname === '/addnote' ? 'text-blue-600' : 'text-black' } group relative rounded-xl bg-gray-100 p-2 hover:bg-gray-50`}>
    ...
    <a href="/profile" class={`${pathname === '/addnote' ? 'text-blue-600' : 'text-black' } group relative rounded-xl bg-gray-100 p-2 hover:bg-gray-50`}>
      <button onClick={handleLogout} class="h-6 w-6 stroke-current group-hover:text-blue-600">
        <LogOutIcon />
      </button>
      <div class="absolute inset-y-0 left-12 hidden items-center group-hover:flex">
          <div class="relative whitespace-nowrap rounded-md bg-white px-4 py-2 text-sm font-semibold group-hover:text-blue-600 text-gray-900 drop-shadow-lg">
            <div class="absolute inset-0 -left-1 flex items-center">
              <div class="h-2 w-2 rotate-45 bg-white"></div>
            </div>
